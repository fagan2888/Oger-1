...
def validate(inputs, outputs, flownode, error_measure, cross_validate_function=n_fold_random, *args, **kwargs):
    '''
    validate(inputs, outputs, flownode, error_measure, cross_validate_function=n_fold_random *args, **kwargs)
