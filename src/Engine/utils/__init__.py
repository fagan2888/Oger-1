...
from error_measures import (timeslice, nrmse, nmse, rmse, mse, loss_01, cosine, ce)


# clean up namespace
del utility_functions
del error_measures
__all__=['get_spectral_radius', 'LinearFunction', 'TanhFunction', 'LogisticFunction', 'SoftmaxFunction', 'SignFunction', 'nrmse', 'nmse', 'rmse', 'mse', 'loss_01', 'cosine', 'ce']
