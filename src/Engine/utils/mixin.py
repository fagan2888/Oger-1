...
def optimize_parameters(original, gridsearch_parameters=None, cross_validate_function=None, error_measure=None, *args, **kwargs):
    ...
    - gridsearch_parameters: the dictionary of optimization parameters and corresponding ranges to use. See the documentation for Engine.evaluation.Optimizer for the format
    ...
    class SelfOptimizingNode():
        ...
        def _optimize(self):
            ...
            opt = Engine.evaluation.Optimizer(self._gridsearch_parameters, self._error_measure)
