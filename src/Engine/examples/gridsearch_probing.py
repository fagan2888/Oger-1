...
class ReservoirNode_lyapunov(Engine.nodes.ReservoirNode):
...
if __name__ == '__main__':
    ...
    # Do the grid search
    opt.grid_search(data, flow, cross_validate_function=Engine.evaluation.train_test_only, training_fraction=.9)
