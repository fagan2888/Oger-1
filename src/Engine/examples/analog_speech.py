...
if __name__ == "__main__":
    ...
    [inputs, outputs] = Engine.datasets.analog_speech(indir="../datasets/Lyon_128")
    ...
    reservoir = Engine.nodes.LeakyReservoirNode(input_dim=input_dim, output_dim=100, input_scaling=1, leak_rate=0.1)
