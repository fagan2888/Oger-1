...
if __name__ == "__main__":
    ...
    [inputs, outputs] = Engine.datasets.analog_speech(indir="/Users/dvrstrae/Documents/workspace/organic-reservoir-computing-engine/src/Engine/datasets/Lyon_128")
    ...
    reservoir = Engine.nodes.BrianIFReservoirNode(input_dim, output_dim=400, dtype=float)
