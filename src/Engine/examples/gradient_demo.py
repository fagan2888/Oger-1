...
# Generate 1-12-1 MLP 
percnode1 = Engine.nodes.PerceptronNode(1, 12, transfer_func=Engine.utils.TanhFunction)
percnode2 = Engine.nodes.PerceptronNode(12, 1)
...
4: L-BFGS-B
...""")
choices = [Engine.gradient.CGTrainer(), Engine.gradient.BFGSTrainer(),
           Engine.gradient.GradientDescentTrainer(epochs=30000),
           Engine.gradient.RPROPTrainer(epochs=30000), Engine.gradient.LBFGSBTrainer(weight_bounds=(-10, 10))]

bpnode = Engine.gradient.BackpropNode(myflow, choices[choice], loss_func=Engine.utils.mse)
