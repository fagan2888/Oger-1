...
class ReservoirNodeTest(unittest.TestCase):
    ...
    def test_spectral_radius(self):
        ...
        # Default value
        r = Oger.nodes.ReservoirNode (output_dim=self.default_size)
        nose.tools.assert_almost_equals(Oger.utils.get_spectral_radius(r.w), sp.amax(sp.absolute(sp.linalg.eigvals(r.w)))) 

        # Custom value
        rho = 0.1
        r = Oger.nodes.ReservoirNode (output_dim=self.default_size, spectral_radius=rho)
    ...
    def test_input_mapping(self):
        ...
        '''
        r = Oger.nodes.ReservoirNode (output_dim=self.default_size, spectral_radius=0)
    ...
    def test_bias(self):
        ...
        '''
        r = Oger.nodes.ReservoirNode (output_dim=self.default_size, spectral_radius=0, bias_scaling=1)
    ...
    def test_passing_custom_reservoir_matrix(self):
        ...
        r = Oger.nodes.ReservoirNode (output_dim=2, w=sp.array([[1, 2], [3, 4]]))
    ...
    def test_passing_custom_reservoir_matrix_function(self):
        ...
        '''
        # Check if weight matrix is initialized correctly
        r = Oger.nodes.ReservoirNode (output_dim=2, w=sp.ones((2, 2)))
        ...
        nose.tools.assert_raises(mdp.NodeException, Oger.nodes.ReservoirNode, output_dim=2, w=sp.ones((1, 1)))

    def test_passing_custom_input_matrix(self):
        ''' Test if passing your own input weight matrix gives expected results 
        '''
        # Check if weight matrix is initialized correctly
        r = Oger.nodes.ReservoirNode (output_dim=2, w_in=sp.array([[1], [2]]))
        ...
        # Check if dimensionality is checked correctly
        nose.tools.assert_raises(mdp.NodeException, Oger.nodes.ReservoirNode, output_dim=2, w_in=sp.array([[1]]))
    ...
    def test_passing_custom_input_matrix_function(self):
        ...
        '''
        # Check if weight matrix is initialized correctly
        r = Oger.nodes.ReservoirNode (output_dim=2, w_in=sp.ones((2, 1)))
        ...
        # Check if dimensionality is checked correctly
        nose.tools.assert_raises(mdp.NodeException, Oger.nodes.ReservoirNode, output_dim=2, w_in=sp.ones((1, 1)))
    ...
    def test_passing_custom_bias_matrix(self):
        ...
        '''
        # Check if weight matrix is initialized correctly
        r = Oger.nodes.ReservoirNode (output_dim=2, w_bias=sp.array([1, 2]))
        ...
        # Check if dimensionality is checked correctly
        nose.tools.assert_raises(mdp.NodeException, Oger.nodes.ReservoirNode, output_dim=2, w_bias=sp.array([[1]]))
    ...
    def test_passing_custom_bias_matrix_function(self):
        ...
        '''
        # Check if weight matrix is initialized correctly
        r = Oger.nodes.ReservoirNode (output_dim=2, w_bias=sp.ones((2)))
        ...
        # Check if dimensionality is checked correctly
        nose.tools.assert_raises(mdp.NodeException, Oger.nodes.ReservoirNode, output_dim=2, w_bias=sp.ones((1)))
