...
import Oger
import pylab
import Oger.odesolver
import numpy

class OdeLeakyIntegrator(Oger.odesolver.OdeProblemPython):
        ...
        def __init__(self, leak_rate = 1.0, input_dim = 1, output_dim = 100, **kwargs):
                ...
                self.conn_mat *= self.spectral_radius/Oger.utils.get_spectral_radius(self.conn_mat)
...
if __name__ == "__main__":
        ...
        [x,y] = Oger.datasets.narma30(sample_len=9000)
        ...
        reservoir = Oger.nodes.OdeNode(inputs,nr_nodes,odeproblem=op, dt = 0.1, init_dt = 1e-5, dt_min = 1e-6, dt_max = 0.05)
        ...
        print Oger.utils.nrmse(y[1],testout, discard=washout)
        print "finished"
